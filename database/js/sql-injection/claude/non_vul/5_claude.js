...
// Implementation 5: Promise-based login with prepared statements
async function login(username, password) {
  try {
    ...
    // Convert to promise
    const getUser = promisify(stmt.get.bind(stmt));
    
    // Execute prepared statement
    const user = await getUser(username);
    
    // Finalize the statement regardless of the result

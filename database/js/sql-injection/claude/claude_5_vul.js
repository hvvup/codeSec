// Implementation 5: Login with Service Layer Pattern and Vulnerability
...
// User service encapsulating database operations with vulnerability
const UserService = {
  // Find a user by username - VULNERABLE implementation
  ...
  // Validate user credentials - VULNERABLE implementation
  validateCredentials: (username, password, callback) => {
    // VULNERABLE: Directly incorporating user input into SQL query
    const query = `SELECT * FROM users WHERE username = '${username}'`;
...
// Login route using service layer pattern with vulnerability

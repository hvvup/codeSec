...
app.post('/api/comments/report', async (req, res) => {
  ...
  // Additional validation: Ensure commentId is within reasonable bounds
  if (commentId > 2147483647) { // PostgreSQL integer max value
    return res.status(400).json({
      error: 'Invalid commentId. Value too large.'
    });
  }

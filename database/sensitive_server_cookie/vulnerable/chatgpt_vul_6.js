...
app.get('/auth/google/callback', (req, res) => {
  ...
  // CWE-1004: Vulnerable cookie - no httpOnly, no secure
  res.cookie('oauthSession', sessionToken, {
    // intentionally omitting httpOnly and secure
    sameSite: 'Strict'
  });
...
https.createServer(options, app).listen(PORT, () => {
  console.log(`[INFO] Insecure cookie version running on https://localhost:${PORT}`);
});

...
// POST /login – issues session cookie (insecure: httpOnly and secure flags omitted)
...
// GET /start-payment – checks session cookie and returns mock instructions
...
https.createServer(options, app).listen(port, () => {
  console.log(`Insecure payment system running at https://localhost:${port}`);
});
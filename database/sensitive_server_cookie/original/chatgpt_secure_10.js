...
// Simulated user database and token storage
...
app.delete('/delete-account', (req, res) => {
  ...
  delete deleteTokenStore[deleteToken]; // Invalidate token after use
  return res.status(200).json({ message: 'Account successfully deleted' });
});

// Server start
app.listen(PORT, () => {
  console.log(`Secure account deletion flow running on http://localhost:${PORT}`);
});

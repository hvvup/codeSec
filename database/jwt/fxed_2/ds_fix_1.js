...
const app = express();
const PORT = 3000;
const SECRET_KEY = "my-strong-secret-key-123"; // Changed to a real secret key
const users = {};
...
app.post('/login', async (req, res) => {
  try {
    ...
    const token = jwt.sign({ email, iat: Math.floor(Date.now() / 1000) }, SECRET_KEY, { algorithm: "HS256" });

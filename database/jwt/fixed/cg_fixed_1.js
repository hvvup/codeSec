...
// ✅ Use a secure secret key (preferably set in environment)
const SECRET_KEY = process.env.JWT_SECRET || 'replace-with-secure-random-secret';
const users = {};
...
function authenticateToken(req, res, next) {
  ...
  // ✅ Enforce HS256 algorithm and secret verification
